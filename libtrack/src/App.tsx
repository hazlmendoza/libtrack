...
function App() {
  return (
    <div
      className="h-screen bg-fixed bg-cover bg-center bg-red flex flex-col min-h-screen "
    ...
    >
      ...
      <footer>
        <div className="flex flex-col items-center justify-center round rounded-t-full bg-white w-full">
